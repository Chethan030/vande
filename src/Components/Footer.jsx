          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <span> Thimmapur-M-Tadakod, Khanapur-M-Tadakod, Karnataka 581105 , Karnataka, India</span>
              </li>
              <li className="flex items-center space-x-3">
                ...
                <a href="tel:+919876543210" className="hover:text-yellow-400 transition-colors">+91 9916963664 / 8217474419 / 9036110872</a>
              </li>
              <li className="flex items-center space-x-3">
                ...
                <a href="mailto:contact@vandemataramgurukulam.org" className="hover:text-yellow-400 transition-colors">@vmgurukulam.acc@gmail.com</a>
              </li>
            </ul>
          </div>
        </div>
